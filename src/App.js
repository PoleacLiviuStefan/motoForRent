...
function App() {
  return (
    <div className="App">
      ...
      <Route path="/BMW-r1200gs" element={<MotorcyclesReservation  imagini={[bmw]} name={<>BMW<span className='text-[#F9844A]'> R1200GS ADVENTURE </span></>} preturi={["90","75"]} an="2007" cp="100" rezervor="33" cmc="1170" greutate="223" garantie="700" transmisie="6" autonomie="300 - 340" abs="standard" inaltime="895" topCase={true} gentiLaterale={true} />} />
    </Routes>
