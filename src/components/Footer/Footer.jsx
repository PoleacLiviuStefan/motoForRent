...
const Footer = () => {
  ...
  return (
    <div name="Footer" className='relative mt-[10rem] bg-orange-400 w-full h-[50rem] lg:h-[25rem] flex flex-col items-center lg:justify-between py-[6rem] lg:py-0 lg:px-[10rem] lg:grid lg:grid-cols-3  '>
         <Link
            activeClass="active"
            to="Hero"
            spy={true}
        ...
        <div className='flex flex-col text-white items-center h-[12rem] mt-[8rem] '>
            ...
            <h3 className=' flex'><span className='mr-2 mt-1'><FiMapPin /></span>Sector 3 , Bucuresti</h3>
