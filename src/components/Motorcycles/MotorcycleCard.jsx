  ...
  return (
    ...
    <div onClick={()=>{window.scrollTo({top: 0, left: 0})}} className='relative bg-white h-[34rem] lg:h-[37rem] w-full lg:w-[30rem] flex flex-col  items-center mt-[3rem] lg:mt-0  '>
          <div className='relative  h-[343px] lg:h-[25rem]'>
           <img className='w-[300px] lg:w-[350px] h-[343px] lg:h-[400px] scale-100 hover:scale-110 transition-all duration-500 cursor-pointer' src={image} alt />
          </div>
          ...
          <div className='flex w-full justify-between text-[11px] lg:text-[14px] '>
            ...
            <div className='flex'><span className='mr-1 mt-1 text-[#F9844A]'><TbEngine /></span> {cmc} cmc</div>
          </div>
          <button className='absolute flex justify-center items-center tracking-[2px] font-bold bottom-0 bg-[#F9844A] rounded-[5px] w-[20rem] lg:w-full h-[4rem] text-white animate-[reverseRezervaHoverBtn_.5s_ease-in-out_forwards] hover:animate-[rezervaHoverBtn_.5s_ease-in-out_forwards] text-[14px]'>
