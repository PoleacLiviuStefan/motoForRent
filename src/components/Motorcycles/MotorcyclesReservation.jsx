...
const MotorcyclesReservation = ({locked,name,imagini,preturi,an,cp,rezervor,cmc,greutate,garantie,transmisie,autonomie,abs,inaltime,topCase,gentiLaterale=false}) => {
          ...
          <div className='absolute top-[90rem] lg:top-[75rem] z-40 flex flex-col items-center w-full  bg-gray-100 h-[50rem] w-full'>
              ...
              <div className='flex flex-col mt-[2rem] w-full items-center text-white justify-center   '>
                ...
                <div className={`relative ${!topCase && "hidden"} flex mt-[.5rem] w-[80%] lg:w-[60%] justify-between items-center h-[4rem]  `}>
                  ...
                  <img className='relative right-4 w-[60px] h-[54px]  ' src={topCaseImg} />
                  <div className='flex w-full justify-between items-center h-[4rem] rounded-[5px] px-4 bg-gradient-to-r from-[#F9844A] to-[#FF712B]'>
