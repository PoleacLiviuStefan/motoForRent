...
const Tururi = () => {
  ...
  return (
    <div name="Tururi" className='relative mt-[5rem] flex flex-col items-center w-full h-[100rem] lg:h-[80rem]    '>
      ...
      <Fade top>
        <h1 className='text-[28px] mt-[1rem] w-[70%] lg:w-full text-center text-left lg:text-[56px] font-[800]'>CURSURI DE PERFECTIONARE</h1>
        </Fade> 
        <Fade bottom>
        ...
        <div className='text-gray-500 mt-[2rem] lg:mt-0 lg:ml-[2rem]'>
            ...
            <ul className='text-black font-bold  text-[24px] mt-[1rem] '>
              ...
              <li  className='relative flex flex-col mt-[1rem] w-[20rem]'>
                <div  className='flex items-center cursor-pointer'> <span className='text-[#F9844A] text-[20px] mr-2 '><AiOutlineCheckSquare /></span > Tura De O Zi <span className={`absolute right-0  ${showText==2 ? "animate-[rotateArrow_.5s_ease-in-out_forwards]" :"animate-[reverseRotateArrow_.5s_ease-in-out_forwards]"} `}><MdArrowForwardIos /></span></div>
              ...
              <li  className='relative flex flex-col mt-[1rem] w-[20rem]'>
                  ...
                  <p className={`${showText!=3 ? "hidden":"animate-[appearText_.5s_ease-in-out_forwards]"}  text-[14px] lg:text-[16px] mt-[.5rem] text-gray-600 font-[300]  `}></p>
                 </li>
