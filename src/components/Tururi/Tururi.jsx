  ...
  return (
    <div name="Tururi" className='flex flex-col items-center mt-[10rem] lg:mt-[10rem]  '>
        ...
        <p>
          ...
          <br/>
          <br/>
         Lorem ipsum dolor sit amet consectetur, adipisicing elit. Animi enim excepturi, hic iste voluptatibus ducimus voluptatum molestias veritatis in cum aperiam exercitationem reprehenderit nostrum explicabo iusto quas quidem unde ex asperiores ratione. Earum corrupti atque sunt cumque porro reiciendis quae rem delectus. Cupiditate minus, facere repellendus sunt accusamus veniam nostrum.
        </p>
        </div>
